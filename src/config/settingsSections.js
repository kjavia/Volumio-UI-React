  ...
  return [
    {
      ...
      fields: [
        ...
        { id: 'hideTrackTimes', element: 'switch', label: t('HIDE_TRACK_TIMES', 'Hide Track Times'), icon: 'timer_off', doc: t('HIDE_TRACK_TIMES_DESC', 'Hide the elapsed and remaining/total time labels below the seek bar.') },
        { id: 'showRemainingTime', element: 'switch', label: t('SHOW_REMAINING_TIME', 'Show Remaining Time'), icon: 'timer', doc: t('SHOW_REMAINING_TIME_DESC', 'Show remaining time instead of total duration.'), visibleIf: { field: 'hideTrackTimes', value: false } },
    ...
    },
    {
      ...
      fields: [
        ...
        { id: 'clockBackgroundColor', element: 'color', label: t('CLOCK_BACKGROUND_COLOR', 'LED Matrix Background Color'), icon: 'format_color_fill', doc: t('CLOCK_BACKGROUND_COLOR_DESC', 'Background behind the LED matrix clock (outside the frame). Leave empty for theme default.'), visibleIf: { field: 'idleScreen', value: 'ledMatrixClock' } },
        { id: 'clockFrameColor', element: 'color', label: t('CLOCK_FRAME_COLOR', 'LED Matrix Frame Color'), icon: 'crop_square', doc: t('CLOCK_FRAME_COLOR_DESC', 'Colour of the outer bezel / frame around the LED matrix clock. Leave empty for theme default.'), visibleIf: { field: 'idleScreen', value: 'ledMatrixClock' } },
        { id: 'clockFaceColor', element: 'color', label: t('CLOCK_FACE_COLOR', 'LED Matrix Face Color'), icon: 'panorama_wide_angle', doc: t('CLOCK_FACE_COLOR_DESC', 'Colour of the inner LED panel behind the dots. Leave empty for theme default.'), visibleIf: { field: 'idleScreen', value: 'ledMatrixClock' } },
        { id: 'clockFontColor', element: 'color', label: t('CLOCK_FONT_COLOR', 'LED Matrix Font Color'), icon: 'text_format', doc: t('CLOCK_FONT_COLOR_DESC', 'Colour of the LED dots, AM/PM, date and weather text. Leave empty for theme default.'), visibleIf: { field: 'idleScreen', value: 'ledMatrixClock' } },
      ],
    },
    {
      id: 'section_weather',
